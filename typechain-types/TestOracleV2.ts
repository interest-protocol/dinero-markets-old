...
export interface TestOracleV2Interface extends utils.Interface {
  contractName: "TestOracleV2";
  functions: {
...
export interface TestOracleV2 extends BaseContract {
  contractName: "TestOracleV2";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestOracleV2Interface;
