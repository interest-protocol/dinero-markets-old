...
export interface TestLPVaultV2Interface extends utils.Interface {
  contractName: "TestLPVaultV2";
  functions: {
...
export interface TestLPVaultV2 extends BaseContract {
  contractName: "TestLPVaultV2";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestLPVaultV2Interface;
