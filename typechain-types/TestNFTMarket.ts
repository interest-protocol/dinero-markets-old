...
export interface TestNFTMarketInterface extends utils.Interface {
  contractName: "TestNFTMarket";
  functions: {
  ...
  encodeFunctionData(functionFragment: "stealBNB", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "stealBNB", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "transferOwnership",
    data: BytesLike
  ): Result;
...
export interface TestNFTMarket extends BaseContract {
  contractName: "TestNFTMarket";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestNFTMarketInterface;
  ...
  callStatic: {
    ...
    stealBNB(overrides?: CallOverrides): Promise<void>;
