...
export interface TestInterestMarketV2Interface extends utils.Interface {
  contractName: "TestInterestMarketV2";
  functions: {
...
export interface TestInterestMarketV2 extends BaseContract {
  contractName: "TestInterestMarketV2";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestInterestMarketV2Interface;
