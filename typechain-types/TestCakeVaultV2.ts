...
export interface TestCakeVaultV2Interface extends utils.Interface {
  contractName: "TestCakeVaultV2";
  functions: {
...
export interface TestCakeVaultV2 extends BaseContract {
  contractName: "TestCakeVaultV2";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestCakeVaultV2Interface;
